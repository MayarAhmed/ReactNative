...
<ScrollView
  ...
  <ScrollView
   horizontal = {true}>
 {/* First Card */}
   <View style={{height:130, width:130,marginLeft:20,borderWidth:1,borderRadius:10}}>
  <View style={{flex:1}}>
    <ImageBackground source={require('../../assets/compil.jpg')} style={styles.imgBack}>
...
{/* Second Card */}
  ...
  <View style={{flex:1}}>
    <ImageBackground source={require('../../assets/track/track6.jpg')} style={styles.imgBack}>
      <Text style={styles.imgTitle}>Deep Blue</Text>
      <Text style={styles.imgDesc}>2380 Tracks </Text>
  </ImageBackground>
  </View>
